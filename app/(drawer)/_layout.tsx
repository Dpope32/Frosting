...
export default function DrawerLayout() {
  ...
  const drawerWidth = isWeb ? typeof window !== 'undefined' ? Math.min(200, window.innerWidth * 0.22) : 220 : isIpadDevice ? 210 : 200;
  ...
  const drawerScreenOptions = useMemo(() => {
    const darkerPrimaryColor = adjustColor(primaryColor, -0.1); 
    ...
    const options: any = {
      ...
      drawerLabelStyle: { fontSize: isIpadDevice ? 20 : 18, fontWeight: (isWeb ? '400' : '500'), marginLeft: isWeb ? -8 : 0, lineHeight: isIpadDevice ? 22 : 20 },
