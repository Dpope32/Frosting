          ...
          {stocks.map(stock => {
            ...
            return (
              ...
              >
                ...
                {activeTab === 'portfolio' && (
                  <Text width="8%" color={isDark ? "#e6e6e6" : "#000"} fontSize={14} fontFamily="$body">
                    {stock.quantity}
                  </Text>
                )}
                <Text width="10%" color={isDark ? "#e6e6e6" : "#000"} fontSize={14} fontFamily="$body">
                <Text color={isDark ? "#4caf50" : "#2e7d32"} fontSize={10} fontFamily="$body"></Text>{currentPrice.toFixed(2)}
                </Text>
                {activeTab === 'portfolio' && (
                <Text 
                    width="10%" 
                    ...
                    fontFamily="$body"
                >
                    <Text color={isDark ? "#4caf50" : "#2e7d32"} fontSize={10} fontFamily="$body"></Text>{totalValue.toFixed(2)}
                </Text>
                )}
                <Text
                  width="10%"
