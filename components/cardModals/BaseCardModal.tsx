...
import { KeyboardAvoidingView, Platform, useColorScheme, StatusBar } from 'react-native'
  ...
  return (
    <Theme name={isDark ? "dark" : "light"}>
      ...
      >
        ...
        <Sheet.Frame
          padding="$4"
          backgroundColor={isDark ? "rgba(17,17,17,0.98)" : "rgba(250,250,250,0.93)"}
        ...
        >
          ...
          <KeyboardAvoidingView
            ...
            style={{ 
              flex: 1,
              paddingTop: Math.max(topInset - 100, 0)
            }}
          >
            <Animated.View
